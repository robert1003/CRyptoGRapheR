...
\fancyhead[L]{National Taiwan University CRyptoGRapheR}
\fancyhead[R]{\thepage}
...
\lstinputlisting{basic/custom_hash.cpp}

\subsection{Fast Division/Modular}
\lstinputlisting{basic/fastDiv.cpp}
...
\lstinputlisting{math/PolyInterpolate.cpp}
...
\subsection{Simplex}
\lstinputlisting{math/simplex2.cpp}
...
%\lstinputlisting{math/divsumAndModsum.cpp}

\subsection{Sum of Division/Modular}
\lstinputlisting{math/divsum.cpp}

\subsection{Fraction Binary Search}
\lstinputlisting{math/fracBinarySearch.cpp}

\subsection{Closest Fraction}
\lstinputlisting{math/continuedFraction.cpp}
...
\lstinputlisting{math/LinearBasis.cpp}

\subsection{Subset Convolution}
\lstinputlisting{math/subsetConv.cpp}
...
\subsection{Intersection of polygon and circle}
\lstinputlisting{geometry/Intersection_of_polygon_and_circle_2.cpp}
...
\subsection{Distance of two segments}
\lstinputlisting{geometry/DistanceOfTwoSegments.cpp}

\subsection{Circle cover}
\lstinputlisting{geometry/CircleCover.cpp}

%\subsection{Intersection of segments set}
%\lstinputlisting{geometry/All_Pair_SSIntersection.cpp}
...
\subsection{Convex Hull Diameter}
\lstinputlisting{geometry/HullDiameter.cpp}
...
\lstinputlisting{geometry/Tangent_line_of_point_and_circle.cpp}

\subsection{Min distance of two convex}
\lstinputlisting{geometry/MinDistOfTwoConvex.cpp}

%\subsection{KD Tree}
%\lstinputlisting{geometry/KDTree1.cpp}
...
\subsection{Min and Max Enclosing Rectangle}
\lstinputlisting{geometry/minMaxEnclosingRectangle2.cpp}
...
%\lstinputlisting{graph/DMST_ElogE.cpp}
\lstinputlisting{graph/DMST_ElogE_recon.cpp}
...
\lstinputlisting{graph/tarjanSCC.cpp}
...
\lstinputlisting{graph/EdgeColoring.cpp}
...
\lstinputlisting{graph/chordal.cpp}
...
\lstinputlisting{graph/GraphMethod.txt}

\section{String}
\subsection{PalTree}
\lstinputlisting{string/PalTree1.cpp}
...
%\subsection{Exact Cover Set}
%\lstinputlisting{others/DLX.cpp}

\subsection{Binary Next Permutation}
\lstinputlisting{others/binary_next_permutation.cpp}

\subsection{Hilbert Curve}
\lstinputlisting{others/HilbertCurve.cpp}
